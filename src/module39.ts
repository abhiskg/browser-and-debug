...
// Callback Function
function greetings(greetingHandler: Function, name: string) {
  greetingHandler(name);
}

function greetingMorning(name: string) {
  console.log("Good Morning", name);
}

function greetingEvening(name: string) {
